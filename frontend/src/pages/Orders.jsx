            ...
            <div className="bg-white rounded border p-4">
              <div className="flex justify-between items-start mb-3">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Creado: {new Date(selected.createdAt).toLocaleDateString()}</p>
                </div>
              ...
              {selected.notas && <div className="mt-2 text-sm"><span className="text-gray-500">Notas:</span> {selected.notas}</div>}
            </div>
              ...
              <table className="w-full text-xs">
                ...
                <tfoot>
                  <tr className="border-t-2 border-gray-400">
                    ...
                    <td className="px-2 py-2 text-right font-bold text-green-700 text-sm">${Number(selected.total).toLocaleString()}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
            ...
            <div className="p-4 space-y-4 text-sm">
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-lg border-2 font-semibold transition-all ${
                        form.tipo_cliente === tipo
                          ? tipo === 'Mayorista' ? 'border-blue-600 bg-blue-600 text-white' : 'border-green-600 bg-green-600 text-white'
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  {refLoading && <div className="absolute right-2 top-2 text-gray-400 text-xs">Buscando...</div>}
                  {refResults.length > 0 && (
                    <div className="absolute z-10 w-full bg-white border rounded shadow-lg mt-1 max-h-48 overflow-y-auto">
                      {refResults.map(ref => (
                        <div key={ref._id} onClick={() => addItem(ref)}
                  ...
                  <table className="w-full text-xs border rounded">
                        ...
                        <tr key={idx} className="border-t">
                          ...
                          <td className="px-2 py-1">
                            <input type="number" value={item.cantidad}
                              ...
                              className="w-16 border rounded px-1 py-0.5 text-center" min="1" />
                          </td>
                          <td className="px-2 py-1 text-right font-semibold">${Number(item.subtotal).toLocaleString()}</td>
                          <td className="px-2 py-1">
                    ...
                    <tfoot>
                      <tr className="border-t-2">
                        <td colSpan="4" className="px-2 py-2 text-right font-bold">TOTAL:</td>
                        <td className="px-2 py-2 text-right font-bold text-green-700">${getTotal().toLocaleString()}</td>
                        <td></td>
                      </tr>
                    </tfoot>
                  </table>
